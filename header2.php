	...
	<body style="background: black;">
		...
		<div class="floating-navigation show">
			...
			<ul class="float-nav-ul">
				...
				<li class="nost-nav-mobile"><a id="nost-nav-account" href="guide" marked="1"><i class="fas fa-street-view "></i><span>My Account</span></a><div class="nav-text"><a href="guide" marked="1">Guide</a></div></li>
				...
				<li class="nost-nav-mobile"><a id="nost-nav-shop" href="founderpacks" marked="1"><i class="fas fa-donate "></i><span>nost Points</span></a><div class="nav-text"><a href="founderpacks" marked="1">Founder Packs</a></div></li>
