...
@media only screen and (max-width: 768px) {
  body {
    background-image: url('../img/gallery/a.jpg');
  }
}
...
100% {
background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)), url('../img/gallery/DNO_Homepage.png');
...
@keyframes bgfadev2 {
0% {
background-image: linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.5)), url('../img/bg2.jpg');
background-size: 100% 100%;
...
.info {
animation: bgfadev3 10s infinite alternate;
background-size:cover;
background-position:center;
background-color:#000;
position:relative;
...
@keyframes bgfadev3 {
0% {
background-image: linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.5)), url('../img/a.jpg');
background-size: 100% 100%;
